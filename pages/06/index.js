...
const FilterBox = styled(Box)`
  ...
  &::before {
    ...
    width: 100%;
    height: 100%;
    box-shadow: 0 15px 25px rgba(251, 174, 0, 0.7), 0 5px 10px rgba(251, 174, 0, 1);
    pointer-events: none;
...
const Six = () => (
  <Box fullWidth fullHeight bg="#055CF9">
    <Card flexDirection="column" width={375} height={812} justifyContent="flex-start" borderRadius="30px" pt={7} pb={3} bg="background" alignItems="flex-start">
      ...
      <Text ml={5} fontWeight="bold" fontSize={5} color="#3C3A5D">Feed</Text>
      ...
      <Grid fullWidth gridTemplateColumns="repeat(3, 1fr)" gridGap={2} px={5} mb={6}>
        <Filter bg="#FEAC00" color="white" count={24} label="photos" active />
      ...
      <Box fullWidth css={{ overflow: 'hidden', position: "relative" }} height={26} mb={5}>
        <Box width="104%" css={{ position: 'absolute', left: 32 }} justifyContent="space-between">
          <Box px={2} py={1} bg="#FFE6C2" color="oranges.2" borderRadius={4}>
      ...
      <Text ml={5} fontWeight="bold" fontSize={2} mb={2} color="#3C3A5D">My photos</Text>
      ...
      <Text ml={5} fontWeight="bold" fontSize={2} mb={2} color="#3C3A5D">My videos</Text>
